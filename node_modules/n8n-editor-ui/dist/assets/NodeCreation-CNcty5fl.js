const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-DAW2sX8p.js","assets/index-CWcTt6jd.js","assets/index-DXFsvbJ_.css","assets/useCanvasOperations-DTx4vbp_.js","assets/useBugReporting-BxDqzvRW.js","assets/usePinnedData-C5NRkSpx.js","assets/useCanvasOperations-BSKKylIT.css","assets/NodeCreator-DDiuO5S0.css"])))=>i.map(i=>d[i]);
import { bp as useNodeTypesStore, dG as NODE_CREATOR_OPEN_SOURCES, q as computed, g as useI18n, bJ as MANUAL_TRIGGER_NODE_TYPE, ig as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bi as NodeConnectionType, b8 as CHAT_TRIGGER_NODE_TYPE, ih as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, ii as OPEN_AI_NODE_TYPE, h6 as SPLIT_IN_BATCHES_NODE_TYPE, dk as NO_OP_NODE_TYPE, T as useWorkflowsStore, aU as useExternalHooks, bK as WEBHOOK_NODE_TYPE, gN as SCHEDULE_TRIGGER_NODE_TYPE, aC as STICKY_NODE_TYPE, $ as useCanvasStore, gB as AI_CATEGORY_LANGUAGE_MODELS, dR as TRIGGER_NODE_CREATOR_VIEW, ij as QA_CHAIN_NODE_TYPE, ik as AGENT_NODE_TYPE, il as BASIC_CHAIN_NODE_TYPE, im as OPEN_AI_ASSISTANT_NODE_TYPE, d as defineComponent, K as useUIStore, r as ref, ca as useThrottleFn, o as onMounted, x as onBeforeUnmount, m as resolveComponent, c as openBlock, h as createElementBlock, n as normalizeClass, j as createBaseVNode, i as createVNode, w as withCtx, l as unref, dF as KeyboardShortcutTooltip, f as createCommentVNode, e as createBlock, cs as Suspense, F as Fragment, cE as defineAsyncComponent, as as __vitePreload, io as getMidCanvasPosition, ip as DEFAULT_STICKY_WIDTH, iq as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-CWcTt6jd.js";
import { a as useNodeCreatorStore, t as transformNodeType, s as sortNodeCreateElements } from "./useCanvasOperations-DTx4vbp_.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-DAW2sX8p.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0)
    );
    const props = __props;
    const emit = __emit;
