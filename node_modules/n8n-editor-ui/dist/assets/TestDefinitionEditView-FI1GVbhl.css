...
/* BEM
 -------------------------- */
._container_1ogu0_123 {
  width: 100vw;
  height: 100%;
}
._pinButtonContainer_1ogu0_128 {
  position: absolute;
  right: 0;
  display: flex;
...
._pinButton_1ogu0_128 {
  cursor: pointer;
  color: var(--canvas-node--border-color);
  border: none;
}
._notPinnedNode_1ogu0_142 .n8n-node-icon > div,
._pinnedNode_1ogu0_143 .n8n-node-icon > div {
  filter: contrast(40%) brightness(1.5) grayscale(100%);
}
._pinnedNode_1ogu0_143 {
...
/* BEM
 -------------------------- */
._arrowConnector_1mi41_123 {
  position: relative;
  height: var(--arrow-height, 3rem);
  margin: 0.5rem 0;
}
._arrowConnector_1mi41_123::before, ._arrowConnector_1mi41_123::after {
  content: "";
  position: absolute;
  left: 50%;
  transform: translateX(-50%);
}
._arrowConnector_1mi41_123::before {
  top: 0;
  width: 2px;
  height: calc(100% - 8px);
  background-color: var(--color-text-dark);
}
._arrowConnector_1mi41_123::after {
  bottom: 0;
  width: 0;
  height: 0;
...
/* BEM
 -------------------------- */
._tagsRead_z5pm4_123:hover ._editInputButton_z5pm4_123 {
  opacity: 1;
}
._editInputButton_z5pm4_123 {
  opacity: 0;
  border: none;
  --button-font-color: var(--prim-gray-490);
}/* BEM support Func
...
/* BEM
 -------------------------- */
._metricsContainer_1eaf8_123 {
  display: flex;
  flex-direction: column;
  gap: var(--spacing-xs);
}
._metricItem_1eaf8_129 {
  display: flex;
  align-items: center;
}
._metricField_1eaf8_134 {
  width: 100%;
  margin-top: var(--spacing-xs);
}
._metricsDivider_1eaf8_139 {
  margin-top: var(--spacing-4xs);
  margin-bottom: var(--spacing-3xs);
}
._newMetricButton_1eaf8_144 {
