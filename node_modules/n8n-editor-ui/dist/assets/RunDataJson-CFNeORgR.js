const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-COFXneND.js","assets/index-CWcTt6jd.js","assets/index-DXFsvbJ_.css","assets/usePinnedData-C5NRkSpx.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, at as useNDVStore, r as ref, iy as nonExistingJsonPath, iz as useElementSize, q as computed, cG as executionDataToJson, c as openBlock, h as createElementBlock, e as createBlock, w as withCtx, l as unref, f as createCommentVNode, cs as Suspense, i as createVNode, it as MappingPill, iu as TextWithHighlights, n as normalizeClass, c9 as Draggable, cE as defineAsyncComponent, as as __vitePreload, v as shorten, ix as getMappedExpression, dn as isString, aU as useExternalHooks, ak as useTelemetry, _ as _export_sfc } from "./index-CWcTt6jd.js";
import { V as VueJsonPretty } from "./NodeViewSwitcher-mtWBt9cw.js";
import "./useCanvasOperations-DTx4vbp_.js";
import "./useBugReporting-BxDqzvRW.js";
import "./usePinnedData-C5NRkSpx.js";
import "./useRunWorkflow-C_vazd74.js";
import "./useExecutionHelpers-DcyS3__o.js";
import "./FileSaver.min-C1QTiJmy.js";
import "./useWorkflowActivate-Dxi5zSSs.js";
import "./pushConnection.store-CTrZ_kO6.js";
import "./useExecutionDebugging-DjYGtT4w.js";
import "./useNodeViewVersionSwitcher-CXU1PYlK.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-COFXneND.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
