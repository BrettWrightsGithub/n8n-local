...
const _hoisted_4$1 = { class: "mb-4xs" };
    ...
    const workflowMenuItems = computed(() => {
      ...
      if (settingsStore.isCanvasV2Enabled) {
        actions.push({
          ...
          ...nodeViewVersion.value === "2" ? nodeViewSwitcherDiscovered.value || isNewUser.value ? {} : {
                ...
                content: withCtx(() => [
                  createBaseVNode("div", _hoisted_4$1, [
                    createVNode(_component_N8nBadge, null, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(i18n).baseText("menuActions.badge.beta")), 1)
                      ]),
                      _: 1
                    })
                  ]),
                  createBaseVNode("p", null, toDisplayString(unref(i18n).baseText("menuActions.nodeViewDiscovery.tooltip")), 1),
                  createVNode(_component_N8nText, {
                    color: "text-light",
                    size: "small"
                  }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(unref(i18n).baseText("menuActions.nodeViewDiscovery.tooltip.switchBack")), 1)
                    ]),
                    _: 1
                  }),
...
const container$1 = "_container_i8q4d_123";
const group = "_group_i8q4d_131";
const hiddenInput = "_hiddenInput_i8q4d_136";
const deleteItem = "_deleteItem_i8q4d_140";
const disabledShareButton = "_disabledShareButton_i8q4d_144";
const closeNodeViewDiscovery = "_closeNodeViewDiscovery_i8q4d_148";
const style1 = {
...
const WorkflowDetails = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$1], ["__scopeId", "data-v-05d071ca"]]);
...
const container = "_container_j6ct2_123";
const style0 = {
  container
};
const cssModules = {
...
const _hoisted_3 = {
  key: 0,
  class: "github-button hidden-sm-and-down"
};
const _hoisted_4 = { class: "github-button-container" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        showGitHubButton.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
