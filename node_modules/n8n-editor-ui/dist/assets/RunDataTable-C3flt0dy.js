import { d as defineComponent, r as ref, at as useNDVStore, T as useWorkflowsStore, cl as storeToRefs, q as computed, o as onMounted, H as watch, m as resolveComponent, c as openBlock, h as createElementBlock, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, F as Fragment, A as renderList, i as createVNode, w as withCtx, ay as withDirectives, e as createBlock, l as unref, aR as _sfc_main$1, az as vShow, aQ as N8nTooltip, k as createTextVNode, t as toDisplayString, cA as InfoTip, c9 as Draggable, it as MappingPill, v as shorten, iu as TextWithHighlights, iv as Tree, g as useI18n, iw as getPairedItemId, ix as getMappedExpression, aU as useExternalHooks, ak as useTelemetry, _ as _export_sfc } from "./index-CWcTt6jd.js";
...
const _hoisted_6 = ["data-row", "data-col"];
const _hoisted_7 = ["data-name", "data-value", "data-depth", "onMouseenter"];
                ...
                return openBlock(), createElementBlock("tr", {
                  ...
                  tableData.value.metadata.hasExecutionIds ? (openBlock(), createElementBlock("td", {
                    ...
                    createVNode(unref(N8nTooltip), {
                      ...
                      default: withCtx(() => [
                        tableData.value.metadata.data[index1] ? withDirectives((openBlock(), createElementBlock("a", {
                          key: 0,
                          href: unref(resolveRelatedExecutionUrl)(tableData.value.metadata.data[index1]),
                          target: "_blank",
                          onClick: ($event) => unref(trackOpeningRelatedExecution)(tableData.value.metadata.data[index1], "table")
                    ...
                    return openBlock(), createElementBlock("td", {
                      ...
                      isSimple(data) ? (openBlock(), createBlock(TextWithHighlights, {
                        ...
                        label: withCtx(({ label, path }) => [
                          ...
                          }, toDisplayString(label || unref(i18n).baseText("runData.unnamedField")), 43, _hoisted_7)
                        ]),
