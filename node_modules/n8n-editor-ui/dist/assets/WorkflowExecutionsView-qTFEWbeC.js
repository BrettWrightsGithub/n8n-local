import { d as defineComponent, U as useRoute, T as useWorkflowsStore, p as useSettingsStore, q as computed, o as onMounted, c as openBlock, h as createElementBlock, i as createVNode, w as withCtx, j as createBaseVNode, e as createBlock, k as createTextVNode, t as toDisplayString, l as unref, n as normalizeClass, f as createCommentVNode, V as VIEWS, g as useI18n, m as resolveComponent, a8 as EnterpriseEditionFeature, _ as _export_sfc, b as useRouter, au as useExecutionsStore, a5 as usePageRedirectionHelper, r as ref, H as watch, F as Fragment, A as renderList, f1 as TransitionGroup, f2 as isComponentPublicInstance, am as getResourcePermissions, a4 as useWorkflowHelpers, eT as onBeforeRouteLeave, dM as getNodeViewTab, ao as MAIN_HEADER_TABS, bp as useNodeTypesStore, a as useToast, J as useDebounce, bq as useNodeHelpers, x as onBeforeUnmount, X as PLACEHOLDER_EMPTY_WORKFLOW_ID, f3 as NO_NETWORK_ERROR_CODE, ak as useTelemetry, eO as NEW_WORKFLOW_ID } from "./index-CWcTt6jd.js";
import { _ as _sfc_main$4, C as ConcurrentExecutionsHeader, E as ExecutionsFilter } from "./ConcurrentExecutionsHeader-Dv0s5rxY.js";
import { u as useExecutionHelpers, t as toDayMonth, a as toTime } from "./useExecutionHelpers-DcyS3__o.js";
import { W as WorkflowExecutionsInfoAccordion } from "./WorkflowExecutionsInfoAccordion-6kKOPXK7.js";
import "./AnnotationTagsDropdown.ee.vue_vue_type_script_setup_true_lang-BhRv3Xk0.js";
...
const WorkflowExecutionsCard$1 = "_WorkflowExecutionsCard_1fc4c_123";
const active = "_active_1fc4c_130";
const executionStatus = "_executionStatus_1fc4c_133";
const executionLink = "_executionLink_1fc4c_136";
const spinner = "_spinner_1fc4c_139";
const running = "_running_1fc4c_139";
const statusLabel = "_statusLabel_1fc4c_146";
const success = "_success_1fc4c_151";
const waiting = "_waiting_1fc4c_160";
const error = "_error_1fc4c_166";
const unknown = "_unknown_1fc4c_172";
const annotation = "_annotation_1fc4c_175";
const ratingIcon = "_ratingIcon_1fc4c_182";
const up = "_up_1fc4c_182";
const down = "_down_1fc4c_185";
const icon = "_icon_1fc4c_202";
const icons = "_icons_1fc4c_207";
const retry = "_retry_1fc4c_215";
const manual = "_manual_1fc4c_218";
const showGap = "_showGap_1fc4c_226";
const style0$2 = {
