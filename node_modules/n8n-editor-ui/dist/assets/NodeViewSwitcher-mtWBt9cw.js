const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataTable-C3flt0dy.js","assets/index-CWcTt6jd.js","assets/index-DXFsvbJ_.css","assets/useExecutionHelpers-DcyS3__o.js","assets/RunDataTable-CX7gToH4.css","assets/RunDataJson-CFNeORgR.js","assets/useCanvasOperations-DTx4vbp_.js","assets/useBugReporting-BxDqzvRW.js","assets/usePinnedData-C5NRkSpx.js","assets/useCanvasOperations-BSKKylIT.css","assets/useRunWorkflow-C_vazd74.js","assets/useRunWorkflow-DWoFsQdi.css","assets/FileSaver.min-C1QTiJmy.js","assets/useWorkflowActivate-Dxi5zSSs.js","assets/pushConnection.store-CTrZ_kO6.js","assets/useExecutionDebugging-DjYGtT4w.js","assets/useNodeViewVersionSwitcher-CXU1PYlK.js","assets/easyAiWorkflowUtils-eykvtlKm.js","assets/RunDataJson-BXTLuo7i.css","assets/RunDataSearch-D9UDSGjR.js","assets/RunDataSearch-R6qtl0Jf.css","assets/NodeCreation-CNcty5fl.js","assets/NodeCreation-RKvezEeg.css","assets/CanvasControls-DhhKk7yf.js","assets/CanvasControls-DTjEPKS0.css","assets/SetupWorkflowCredentialsButton-Bhx7c9Lu.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, r as ref, q as computed, c as openBlock, h as createElementBlock, j as createBaseVNode, i as createVNode, bs as _sfc_main$z, n as normalizeClass, w as withCtx, k as createTextVNode, t as toDisplayString, e as createBlock, f as createCommentVNode, l as unref, G as withKeys, I as withModifiers, g as useI18n, y as nextTick, m as resolveComponent, _ as _export_sfc, at as useNDVStore, T as useWorkflowsStore, bt as isCommunityPackageName, bu as NPM_PACKAGE_DOCS_BASE_URL, bv as BUILTIN_NODES_DOCS_URL, bw as COMMUNITY_NODES_INSTALLATION_DOCS_URL, bi as NodeConnectionType, aU as useExternalHooks, ak as useTelemetry, b as useRouter, b7 as useClipboard, a4 as useWorkflowHelpers, a as useToast, bx as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, H as watch, F as Fragment, A as renderList, by as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, bz as FORM_TRIGGER_NODE_TYPE, b8 as CHAT_TRIGGER_NODE_TYPE, E as onClickOutside, aq as h, bA as toValue, bB as toRef, bC as tryOnScopeDispose, bD as isIOS, bE as noop, bF as isObject, bG as isClient, bp as useNodeTypesStore, bq as useNodeHelpers, J as useDebounce, B as normalizeStyle, bH as nodeIssuesToString, bf as getNodeInputs, bI as TitledList, K as useUIStore, b0 as mergeProps, bJ as MANUAL_TRIGGER_NODE_TYPE, bK as WEBHOOK_NODE_TYPE, bL as AI_TRANSFORM_NODE_TYPE, bM as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, bN as generateCodeForAiTransform, bO as AI_TRANSFORM_JS_CODE, ac as nodeViewEventBus, al as useMessage, ae as MODAL_CONFIRM, bP as SWITCH_NODE_TYPE, bQ as isEqual, bR as captureException, p as useSettingsStore, av as usePostHog, bS as useCredentialsStore, u as useUsersStore, a1 as useProjectsStore, bT as OPEN_AI_API_CREDENTIAL_TYPE, bU as AI_CREDITS_EXPERIMENT, bV as useHistoryStore, o as onMounted, bW as importCurlEventBus, bX as ndvEventBus, x as onBeforeUnmount, bY as CUSTOM_NODES_DOCS_URL, ay as withDirectives, az as vShow, bZ as NodeCredentials, b_ as _sfc_main$A, b$ as ProjectTypes, bg as getConnectionTypes, bk as get, c0 as getNodeParameters, c1 as deepCopy, c2 as set, c3 as unset, c4 as RenameNodeCommand, c5 as isINodePropertyCollectionList, c6 as isINodePropertiesList, c7 as isINodePropertyOptionsList, c8 as displayParameter, c9 as Draggable, ca as useThrottleFn, cb as useSlots, aK as useStorage, cc as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, s as renderSlot, cd as MAIN_NODE_PANEL_WIDTH, ce as requireVue, cf as getDefaultExportFromCjs, cg as sanitizeHtmlExports, ch as sanitizeHtml, ci as jsonParse, aP as N8nLink, cj as N8nText, aR as _sfc_main$B, aQ as N8nTooltip, a0 as useSourceControlStore, Z as useRootStore, U as useRoute, ck as toRef$1, cl as storeToRefs, cm as dataPinningEventBus, cn as MAX_DISPLAY_DATA_SIZE_SCHEMA_VIEW, co as MAX_DISPLAY_DATA_SIZE, cp as HTML_NODE_TYPE, cq as DATA_PINNING_DOCS_URL, cr as N8nCallout, cs as Suspense, ct as N8nRadioButtons, cu as N8nButton, cv as N8nSelect, cw as N8nTabs, cx as _sfc_main$C, cy as JsonEditor, cz as DATA_EDITING_DOCS_URL, cA as InfoTip, cB as _sfc_main$E, cC as _sfc_main$F, cD as N8nBlockUi, cE as defineAsyncComponent, cF as TRIMMED_TASK_DATA_CONNECTIONS_KEY, cG as executionDataToJson, cH as NODE_TYPES_EXCLUDED_FROM_OUTPUT_NAME_APPEND, cI as isEmpty, bh as getNodeOutputs, cJ as getNodeHints, cK as getGenericHints, cL as LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG, cM as LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG, cN as clearJsonKey, cO as searchInObject, cP as isObject$1, cQ as resolveDirective, cR as TEST_PIN_DATA, as as __vitePreload, aT as createSlots, cS as waitingNodeTooltip, cT as isPresent, cU as truncate, cV as createStaticVNode, b1 as resolveDynamicComponent, cW as uniqBy, cX as START_NODE_TYPE, cY as CRON_NODE_TYPE, cZ as INTERVAL_NODE_TYPE, c_ as CopyInput, c$ as Transition, C as createEventBus, d0 as isTriggerPanelObject, d1 as getTriggerNodeServiceName, V as VIEWS, ag as WORKFLOW_SETTINGS_MODAL_KEY, d2 as useDeviceSupport, d3 as APP_MODALS_ELEMENT_ID, d4 as useStyles, d5 as EXECUTABLE_TRIGGER_NODE_TYPES, aC as STICKY_NODE_TYPE, d6 as BASE_NODE_SURVEY_URL, a8 as EnterpriseEditionFeature, d7 as getCurrentInstance, d8 as getAnchorPosition, d9 as isValidNodeConnectionType, da as getEndpointScope, db as getInputEndpointUUID, dc as getInputEndpointStyle, dd as getScope, de as getInputNameOverlay, df as NODE_INSERT_SPACER_BETWEEN_INPUT_GROUPS, dg as NODE_MIN_INPUT_ITEMS_COUNT, dh as getOutputEndpointUUID, di as getOutputEndpointStyle, dj as getOutputNameOverlay, dk as NO_OP_NODE_TYPE, dl as NODE_CONNECTION_TYPE_ALLOW_MULTIPLE, dm as GRID_SIZE, dn as isString, dp as isNumber, dq as assert, dr as CUSTOM_API_CALL_KEY, ds as FontAwesomeIcon, dt as xss, du as WAIT_NODE_TYPE, dv as SEND_AND_WAIT_OPERATION, dw as FORM_NODE_TYPE, dx as WAIT_INDEFINITELY, dy as SIMULATE_NODE_TYPE, dz as SIMULATE_TRIGGER_NODE_TYPE, dA as reactive, b5 as onUnmounted, $ as useCanvasStore, dB as getMousePosition, dC as getRelativePosition, dD as MOUSE_EVENT_BUTTON, dE as MOUSE_EVENT_BUTTONS, dF as KeyboardShortcutTooltip, a3 as useDocumentTitle, dG as NODE_CREATOR_OPEN_SOURCES, dH as mapStores, a2 as useNpsSurveyStore, au as useExecutionsStore, dI as useExternalSecretsStore, dJ as useWorkflowsEEStore, dK as useEnvironmentsStore, aN as useTemplatesStore, D as useTagsStore, dL as getBackgroundStyles, b9 as MANUAL_CHAT_TRIGGER_NODE_TYPE, am as getResourcePermissions, dM as getNodeViewTab, X as PLACEHOLDER_EMPTY_WORKFLOW_ID, ao as MAIN_HEADER_TABS, dN as ready, aG as sourceControlEventBus, dO as historyBus, dP as generateNodesGraph, dQ as N8nAddInputEndpointType, dR as TRIGGER_NODE_CREATOR_VIEW, dS as getFixedNodesList, dT as tryToParseNumber, dU as MoveNodeCommand, ai as VALID_WORKFLOW_IMPORT_URL_REGEX, dV as UPDATE_WEBHOOK_ID_NODE_TYPES, bl as v4, dW as getNewNodePosition, dX as DRAG_EVENT_DATA_KEY, dY as getConnectorLengths, dZ as MAX_X_TO_PUSH_DOWNSTREAM_NODES, d_ as PUSH_NODES_OFFSET, d$ as NODE_SIZE, e0 as generateOffsets, e1 as nodeConnectionTypes, e2 as resetConnectionAfterPull, e3 as resetConnection, e4 as moveBackInputLabelPosition, e5 as hideOutputNameLabel, e6 as addConnectionActionsOverlay, e7 as getOverlay, e8 as OVERLAY_ENDPOINT_ARROW_ID, e9 as getConnectorPaintStyleData, ea as AddConnectionCommand, eb as addConnectionTestData, ec as showOrHideItemsLabel, ed as showOrHideMidpointArrow, ee as isJSPlumbConnection, ef as hideConnectionActions, eg as showConnectionActions, eh as resetInputLabelPosition, ei as getConnectionInfo, ej as showOutputNameLabel, ek as RemoveConnectionCommand, el as isJSPlumbEndpointElement, em as isElementIntersection, en as calculateElementIntersection, eo as showDropConnectionState, ep as showPullConnectionState, eq as AI_NODE_CREATOR_VIEW, er as EVENT_CONNECTION_ABORT, es as INTERCEPT_BEFORE_DROP, et as EVENT_CONNECTION, eu as EVENT_DRAG_MOVE, ev as EVENT_CONNECTION_MOUSEOVER, ew as EVENT_CONNECTION_MOUSEOUT, ex as EVENT_CONNECTION_MOVED, ey as EVENT_ENDPOINT_MOUSEOVER, ez as EVENT_ENDPOINT_MOUSEOUT, eA as EVENT_CONNECTION_DETACHED, eB as EVENT_CONNECTION_DRAG, eC as EVENT_PLUS_ENDPOINT_CLICK, eD as EVENT_ADD_INPUT_ENDPOINT_CLICK, eE as N8nPlusEndpointType, eF as CANVAS_AUTO_ADD_MANUAL_TRIGGER_EXPERIMENT, eG as MODAL_CANCEL, eH as addClassesToOverlays, eI as getJSPlumbEndpoints, eJ as REGULAR_NODE_CREATOR_VIEW, eK as isSubNodeType, eL as useDataSchema, eM as OVERLAY_RUN_ITEMS_ID, eN as RemoveNodeCommand, aa as useCssModule, eO as NEW_WORKFLOW_ID, eP as CanvasNodeRenderType, ax as onBeforeMount, eQ as onActivated, eR as onDeactivated, eS as CanvasConnectionMode, eT as onBeforeRouteLeave } from "./index-CWcTt6jd.js";
import { u as useContextMenu, a as useNodeCreatorStore, C as ContextMenu, b as useUniqueNodeName, c as useViewStacks, d as useVueFlow, e as useCanvasMapping, _ as __unplugin_components_0$1, f as useCanvasOperations, g as createCanvasConnectionHandleString } from "./useCanvasOperations-DTx4vbp_.js";
import { u as usePinnedData, a as useNodeType } from "./usePinnedData-C5NRkSpx.js";
import { u as useRunWorkflow, _ as _sfc_main$D, R as RunDataAi } from "./useRunWorkflow-C_vazd74.js";
import { F as FileSaver_minExports } from "./FileSaver.min-C1QTiJmy.js";
import { u as useExecutionHelpers, c as convertToDisplayDateComponents } from "./useExecutionHelpers-DcyS3__o.js";
import { u as useWorkflowActivate } from "./useWorkflowActivate-Dxi5zSSs.js";
import { g as globalLinkActionsEventBus, u as usePushConnectionStore } from "./pushConnection.store-CTrZ_kO6.js";
import { u as useExecutionDebugging } from "./useExecutionDebugging-DjYGtT4w.js";
import { u as useBeforeUnload, a as useNodeViewVersionSwitcher } from "./useNodeViewVersionSwitcher-CXU1PYlK.js";
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-C3flt0dy.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-CFNeORgR.js"), true ? __vite__mapDeps([5,1,2,6,7,8,9,10,3,11,12,13,14,15,16,17,18]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-CWcTt6jd.js").then((n) => n.iK), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-D9UDSGjR.js"), true ? __vite__mapDeps([19,1,2,20]) : void 0)
    );
    const props = __props;
    const emit = __emit;
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          _ctx.isExecuting && !isWaitNodeWaiting.value ? (openBlock(), createElementBlock("div", {
            ...
            createVNode(unref(N8nButton), {
              size: "small",
              onClick: onExecutionHistoryNavigate
            }, {
              default: withCtx(() => [
                createVNode(unref(_sfc_main$E), {
                  to: `/workflow/${unref(workflowsStore).workflowId}/executions`
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(i18n).baseText("runData.trimmedData.button")), 1)
                  ]),
                  _: 1
                }, 8, ["to"])
              ]),
            ...
            createVNode(unref(N8nSelect), {
              ...
              default: withCtx(() => [
                (openBlock(), createElementBlock(Fragment, null, renderList(pageSizes, (size) => {
                  return createVNode(unref(_sfc_main$F), {
                    key: size,
                    label: size,
                    value: size
                  }, null, 8, ["label", "value"]);
...
const RunData = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__cssModules", cssModules$a], ["__scopeId", "data-v-94c8440a"]]);
...
const mappedNode = "_mappedNode_18clq_123";
const titleSection = "_titleSection_18clq_127";
const inputModeTab = "_inputModeTab_18clq_136";
const noOutputData = "_noOutputData_18clq_140";
const recoveredOutputData = "_recoveredOutputData_18clq_150";
const notConnected = "_notConnected_18clq_159";
const title = "_title_18clq_127";
const style0$4 = {
  mappedNode,
  titleSection,
  inputModeTab,
...
const LazyNodeCreation = defineAsyncComponent(
  async () => await __vitePreload(() => import("./NodeCreation-CNcty5fl.js").then((n) => n.N), true ? __vite__mapDeps([21,1,2,6,7,8,9,22]) : void 0)
);
const LazyCanvasControls = defineAsyncComponent(
  async () => await __vitePreload(() => import("./CanvasControls-DhhKk7yf.js"), true ? __vite__mapDeps([23,1,2,24]) : void 0)
);
const LazySetupWorkflowCredentialsButton = defineAsyncComponent(
  async () => await __vitePreload(() => import("./SetupWorkflowCredentialsButton-Bhx7c9Lu.js"), true ? __vite__mapDeps([25,1,2]) : void 0)
);
...
const NodeViewV1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render], ["__cssModules", cssModules$2], ["__scopeId", "data-v-fda99076"]]);
