...
let SourceControlService = class SourceControlService {
    ...
    async pullWorkfolder(userId, options) {
        await this.sanityCheck();
        ...
        await this.sourceControlImportService.importWorkflowFromWorkFolder(workflowsToBeImported, userId);
        const credentialsToBeImported = statusResult.filter((e) => e.type === 'credential' && e.status !== 'deleted');
        await this.sourceControlImportService.importCredentialsFromWorkFolder(credentialsToBeImported, userId);
