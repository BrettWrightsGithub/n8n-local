...
let JobProcessor = class JobProcessor {
    constructor(logger, errorReporter, executionRepository, workflowRepository, nodeTypes, instanceSettings, manualExecutionService) {
        this.logger = logger;
    ...
    async processJob(job) {
        ...
        additionalData.hooks = WorkflowExecuteAdditionalData.getWorkflowHooksWorkerExecuter(execution.mode, job.data.executionId, execution.workflowData, { retryOf: execution.retryOf, pushRef });
        if (pushRef) {
