...
const cleanupParameterData_1 = require("./utils/cleanupParameterData");
const ensureType_1 = require("./utils/ensureType");
const getAdditionalKeys_1 = require("./utils/getAdditionalKeys");
const validateValueAgainstSchema_1 = require("./utils/validateValueAgainstSchema");
class NodeExecutionContext {
    constructor(workflow, node, additionalData, mode, runExecutionData = null, runIndex = 0, connectionInputData = [], executeData) {
        ...
        this.instanceSettings = di_1.Container.get(InstanceSettings_1.InstanceSettings);
    }
    get logger() {
    ...
    get additionalKeys() {
        return (0, getAdditionalKeys_1.getAdditionalKeys)(this.additionalData, this.mode, this.runExecutionData);
    }
    ...
    _getNodeParameter(parameterName, itemIndex, fallbackValue, options) {
        ...
        try {
            ...
            (0, cleanupParameterData_1.cleanupParameterData)(returnData);
        }
        catch (e) {
        ...
        if (options?.ensureType) {
            returnData = (0, ensureType_1.ensureType)(options.ensureType, returnData, parameterName, {
                itemIndex,
                runIndex,
                nodeCause: node.name,
            });
        }
        returnData = (0, validateValueAgainstSchema_1.validateValueAgainstSchema)(node, nodeType, returnData, parameterName, runIndex, itemIndex);
        return returnData;
    }
