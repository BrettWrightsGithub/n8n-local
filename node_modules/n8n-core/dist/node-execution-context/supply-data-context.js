...
const getInputConnectionData_1 = require("./utils/getInputConnectionData");
class SupplyDataContext extends base_execute_context_1.BaseExecuteContext {
    constructor(workflow, node, additionalData, mode, runExecutionData, runIndex, connectionInputData, inputData, connectionType, executeData, closeFunctions, abortSignal) {
        ...
        this.helpers = {
            ...
            detectBinaryEncoding: (buffer) => (0, NodeExecuteFunctions_1.detectBinaryEncoding)(buffer),
    ...
    async getInputConnectionData(connectionType, itemIndex) {
        return await getInputConnectionData_1.getInputConnectionData.call(this, this.workflow, this.runExecutionData, this.runIndex, this.connectionInputData, this.inputData, this.additionalData, this.executeData, this.mode, this.closeFunctions, connectionType, itemIndex, this.abortSignal);
    }
