...
let InstanceSettings = class InstanceSettings {
    ...
    get isDocker() {
        try {
            return ((0, node_fs_1.existsSync)('/.dockerenv') || (0, node_fs_1.readFileSync)('/proc/self/cgroup', 'utf8').includes('docker'));
        }
        catch {
            return false;
        }
